...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token)
    {
        ...
        $this->email->subject('Verifikasi Akun Olahraga Hari Ini');
        $this->email->message(
            'Silahkan verifikasi akun anda dengan mengklik link berikut: <a href="' . base_url() . '/auth/verify?email=' . $this->input->post('email') . '&token=' . $token . '">Activate</a>'
        );
        if ($this->email->send()) {
            return true;
        } else {
